package com.example.tita.ui.signup.fragment.dialog
...
import com.example.tita.ui.signup.fragment.viewmodel.SchoolViewModel
...
class SearchSchoolFragment :
    ...
    override fun onclick(data: RowEntity) {
        val action=SearchSchoolFragmentDirections.actionSearchSchoolFragmentToSignUpCertificatioSchoolFragment(
